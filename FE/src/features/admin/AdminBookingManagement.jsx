...
const getStatusDisplay = (status) => {
  return (
    BOOKING_STATUS_MAP[status] || { text: status || "Không rõ", className: "role-default" }
  );
};
              ...
              <div className="modal-body">
                ...
                {selectedFeedback && (
                  <div className="feedback-details">
                    <p>
                      <strong>Khách hàng:</strong> {selectedFeedback.userName}
                    </p>
                    <p>
                      <strong>Xe:</strong> {selectedFeedback.licensePlate}
                    </p>
                    <p>
                      <strong>Trung tâm:</strong> {selectedFeedback.centerName}
                    </p>
                    <p>
                      <strong>Ngày:</strong> {formatDate(selectedFeedback.feedbackDate)}
                    </p>
                    ...
                    <p>
                      ...
                      {selectedFeedback.isPublished ? "Đã duyệt" : "Chưa duyệt"}
                    </p>
                  </div>
                )}
              </div>
